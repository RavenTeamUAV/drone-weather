...
const MissionEditor = (() => {
  ...
  const CMD = {
    ...
    16:  { short: 'WAYPOINT',              name: 'Waypoint',                   p: ['Delay s',  'Acc.Rad',  'Pass.Rad', 'Yaw°'   ] },
    17:  { short: 'LOITER_UNLIM',          name: 'Loiter Unlimited',           p: ['',         'Radius',   '',         'Yaw°'   ] },
    18:  { short: 'LOITER_TURNS',          name: 'Loiter Turns',               p: ['Turns',    'Radius',   'Dir',      'Yaw°'   ] },
    19:  { short: 'LOITER_TIME',           name: 'Loiter Time',                p: ['Sec',      'Radius',   '',         'Yaw°'   ] },
    20:  { short: 'RETURN_TO_LAUNCH',      name: 'Return to Launch',           p: ['',         '',         '',         ''       ] },
    21:  { short: 'LAND',                  name: 'Land',                       p: ['Abort Alt','',         '',         'Yaw°'   ] },
    22:  { short: 'TAKEOFF',               name: 'Takeoff',                    p: ['Pitch',    '',         '',         'Yaw°'   ] },
    82:  { short: 'SPLINE_WAYPOINT',       name: 'Spline Waypoint',            p: ['Delay s',  '',         '',         ''       ] },
    84:  { short: 'VTOL_TAKEOFF',          name: 'VTOL Takeoff',               p: ['',         '',         '',         'Yaw°'   ] },
    85:  { short: 'VTOL_LAND',             name: 'VTOL Land',                  p: ['',         '',         '',         'Yaw°'   ] },
    93:  { short: 'LOITER_TO_ALT',         name: 'Loiter to Alt',              p: ['HeadReq',  'Radius',   '',         ''       ] },
    // ── CONDITION — no coordinates ────────────────────────────────────────────
    113: { short: 'CONDITION_DELAY',       name: 'Condition Delay',            p: ['Sec',      '',         '',         ''       ] },
    114: { short: 'CONDITION_CHANGE_ALT',  name: 'Condition Change Alt',       p: ['Alt m',    'Climb',    '',         ''       ] },
    115: { short: 'CONDITION_DISTANCE',    name: 'Condition Distance',         p: ['Dist m',   '',         '',         ''       ] },
    116: { short: 'CONDITION_YAW',         name: 'Condition Yaw',              p: ['Angle°',   'Speed',    'Dir',      'Rel'    ] },
    // ── DO — no coordinates ───────────────────────────────────────────────────
    177: { short: 'DO_JUMP',               name: 'Do Jump',                    p: ['WP#',      'Repeat',   '',         ''       ] },
    178: { short: 'DO_CHANGE_SPEED',       name: 'Do Change Speed',            p: ['Type',     'Spd m/s',  'Thr %',    ''       ] },
    179: { short: 'DO_SET_HOME',           name: 'Do Set Home',                p: ['Current',  '',         '',         ''       ] },
    181: { short: 'DO_SET_RELAY',          name: 'Do Set Relay',               p: ['Relay#',   'On/Off',   '',         ''       ] },
    183: { short: 'DO_SET_SERVO',          name: 'Do Set Servo',               p: ['Servo#',   'PWM',      '',         ''       ] },
    184: { short: 'DO_REPEAT_SERVO',       name: 'Do Repeat Servo',            p: ['Servo#',   'PWM',      'Repeat',   'Delay s'] },
    189: { short: 'DO_LAND_START',         name: 'Do Land Start',              p: ['',         '',         '',         ''       ] },
    201: { short: 'DO_DIGICAM_CONFIGURE',  name: 'Do Digicam Configure',       p: ['Mode',     'Shutter',  'Aperture', 'ISO'    ] },
    202: { short: 'DO_DIGICAM_CONTROL',    name: 'Do Digicam Control',         p: ['Session',  'ZoomPos',  '',         'Focus'  ] },
    203: { short: 'DO_REPEAT_RELAY',       name: 'Do Repeat Relay',            p: ['Relay#',   'Repeat',   'Delay s',  ''       ] },
    206: { short: 'DO_SET_CAM_TRIGG_DIST', name: 'Do Set Cam Trigg Dist',      p: ['Dist m',   '',         '',         ''       ] },
    208: { short: 'DO_PARACHUTE',          name: 'Do Parachute',               p: ['Action',   '',         '',         ''       ] },
  };
